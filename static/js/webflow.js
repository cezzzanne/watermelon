...
Webflow.define('forms', module.exports = function ($, _) {
  ...
  function addListeners() {
    ...
    $doc.on('focus', namespace + ' form input[type="checkbox"]:not(' + CHECKBOX_CLASS_NAME + ')', function (evt) {
      $(evt.target).siblings(CHECKBOX_CLASS_NAME).addClass(FOCUSED_CLASS);
    });
    $doc.on('blur', namespace + ' form input[type="checkbox"]:not(' + CHECKBOX_CLASS_NAME + ')', function (evt) {
      $(evt.target).siblings(CHECKBOX_CLASS_NAME).removeClass(FOCUSED_CLASS);
    });
...
{"events":{"e":{"id":"e","eventTypeId":"PAGE_SCROLL","action":{"id":"","actionTypeId":"GENERAL_CONTINUOUS_ACTION","config":{"actionListId":"a-3","affectedElements":{},"duration":0}},"mediaQueries":["main","medium","small","tiny"],"target":{"appliesTo":"PAGE","styleBlockIds":[],"id":"5d64641099c8ff63fad51eab"},"config":[{"continuousParameterGroupId":"a-3-p","smoothing":50,"startsEntering":true,"addStartOffset":false,"addOffsetValue":50,"startsExiting":false,"addEndOffset":false,"endOffsetValue":50}],"createdOn":1563742368482}},"actionLists":{"a-3":{"id":"a-3","title":"Navbar Transform","continuousParameterGroups":[{"id":"a-3-p","type":"SCROLL_PROGRESS","parameterLabel":"Scroll","continuousActionGroups":[{"keyframe":0,"actionItems":[{"id":"a-3-n","actionTypeId":"STYLE_BACKGROUND_COLOR","config":{"delay":0,"easing":"","duration":500,"target":{"selector":".navbar","selectorGuids":["03e7d6ad-70ca-a89f-7415-986ea77afc60"]},"rValue":0,"gValue":0,"bValue":0,"aValue":0}}]},{"keyframe":10,"actionItems":[{"id":"a-3-n-2","actionTypeId":"STYLE_BACKGROUND_COLOR","config":{"delay":0,"easing":"","duration":500,"target":{"selector":".navbar","selectorGuids":["03e7d6ad-70ca-a89f-7415-986ea77afc60"]},"rValue":0,"gValue":195,"bValue":169,"aValue":1}}]}]}],"createdOn":1563742371781}},"site":{"mediaQueries":[{"key":"main","min":992,"max":10000},{"key":"medium","min":768,"max":991},{"key":"small","min":480,"max":767},{"key":"tiny","min":0,"max":479}]}}
);
